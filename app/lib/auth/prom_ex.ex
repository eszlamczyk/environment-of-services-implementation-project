defmodule Auth.PromEx do
  ...
  3. Update your `endpoint.ex` file to expose your metrics (or configure a standalone
     ...
     defmodule AuthWeb.Endpoint do
       ...
       plug PromEx.Plug, prom_ex_module: Auth.PromEx
  ...
  def plugins do
    [
      ...
      Plugins.Application,
      Plugins.Beam,
      {Plugins.Phoenix, router: AuthWeb.Router, endpoint: AuthWeb.Endpoint},
      Plugins.Ecto,
    ]
  end
  ...
  def dashboards do
    [
      ...
      # {:auth, "/grafana_dashboards/user_metrics.json"}
    ]
  end
end
